...
declare %Object* @"[J]java.lang.StringBuilder.append(I)Ljava/lang/StringBuilder;"(%Env*, %Object*, i32)
...
declare void @"[J]java.lang.StringBuilder.<init>()V"(%Env*, %Object*)
...
@"str_red_5Fjit_2Ejava_00" = weak constant [13 x i8] c"red_jit.java\00"
@"[j]red_jit[cattributes]" = private constant <{i32, <{i8, i8*}>}> <{i32 1, <{i8, i8*}> <{i8 1, i8* getelementptr ([13 x i8]* @"str_red_5Fjit_2Ejava_00", i32 0, i32 0)}>}>
@"str_branch1_3A_00_ptr" = weak global %Object* null
@"str_branch1_3A_00" = weak constant [9 x i8] c"branch1:\00"
@"str_red_5Fjit_00" = weak constant [8 x i8] c"red_jit\00"
@"[j]red_jit[typeinfo]" = external constant i8*
@"[j]red_jit[vtable]" = private constant {i16, [11 x i8*]} {i16 11, [11 x i8*] [i8* bitcast (%Object* (%Env*, %Object*)* @"[J]java.lang.Object.clone()Ljava/lang/Object;" to i8*), i8* bitcast (i8 (%Env*, %Object*, %Object*)* @"[J]java.lang.Object.equals(Ljava/lang/Object;)Z" to i8*), i8* bitcast (void (%Env*, %Object*)* @"[J]java.lang.Object.finalize()V" to i8*), i8* bitcast (%Object* (%Env*, %Object*)* @"[J]java.lang.Object.getClass()Ljava/lang/Class;" to i8*), i8* bitcast (i32 (%Env*, %Object*)* @"[J]java.lang.Object.hashCode()I" to i8*), i8* bitcast (void (%Env*, %Object*)* @"[J]java.lang.Object.notify()V" to i8*), i8* bitcast (void (%Env*, %Object*)* @"[J]java.lang.Object.notifyAll()V" to i8*), i8* bitcast (%Object* (%Env*, %Object*)* @"[J]java.lang.Object.toString()Ljava/lang/String;" to i8*), i8* bitcast (void (%Env*, %Object*)* @"[J]java.lang.Object.wait()V" to i8*), i8* bitcast (void (%Env*, %Object*, i64)* @"[J]java.lang.Object.wait(J)V" to i8*), i8* bitcast (void (%Env*, %Object*, i64, i32)* @"[J]java.lang.Object.wait(JI)V" to i8*)]}
@"str_java_2Flang_2FObject_00" = weak constant [17 x i8] c"java/lang/Object\00"
@"str_iters_5Fto_5Fjit_00" = weak constant [13 x i8] c"iters_to_jit\00"
@"str_scale_00" = weak constant [6 x i8] c"scale\00"
@"str__3Cinit_3E_00" = weak constant [7 x i8] c"<init>\00"
@"[j]red_jit.<init>()V[linetable]" = weak global i32 -1
...
@"[j]red_jit.main([Ljava/lang/String;)V[linetable]" = weak global i32 -1
@"str_branch1_00" = weak constant [8 x i8] c"branch1\00"
@"str__28I_29I_00" = weak constant [5 x i8] c"(I)I\00"
@"[j]red_jit.branch1(I)I[linetable]" = weak global i32 -1
@"str_branch2_00" = weak constant [8 x i8] c"branch2\00"
@"[j]red_jit.branch2(I)I[linetable]" = weak global i32 -1
@"str__3Cclinit_3E_00" = weak constant [9 x i8] c"<clinit>\00"
@"[j]red_jit.<clinit>()V[linetable]" = weak global i32 -1
@"[j]red_jit[infostruct]" = weak global {{i8*, i32, i8*, void (%Env*)*, i8**, i8*, i8*, i32, i32, i32, i16, i16}, <{i16, i16, i16, i8*, i8*, i16, i8*, i32, i16, i8*, i32, i16, i16, i8*, i8, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8, i8*, i32, i32*}>} {{i8*, i32, i8*, void (%Env*)*, i8**, i8*, i8*, i32, i32, i32, i16, i16} {i8* null, i32 129, i8* getelementptr ([8 x i8]* @"str_red_5Fjit_00", i32 0, i32 0), void (%Env*)* @"[J]red_jit.<clinit>()V", i8** @"[j]red_jit[typeinfo]", i8* bitcast ({i16, [11 x i8*]}* @"[j]red_jit[vtable]" to i8*), i8* null, i32 ptrtoint ({%Class, {<{<{}>, i32}>, <{<{}>, i32}>}}* getelementptr ({%Class, {<{<{}>, i32}>, <{<{}>, i32}>}}* null, i32 1) to i32), i32 ptrtoint ({%DataObject, <{<{}>}>}* getelementptr ({%DataObject, <{<{}>}>}* null, i32 1) to i32), i32 ptrtoint ({%DataObject, <{<{}>}>}* getelementptr ({%DataObject, <{<{}>}>}* null, i32 1) to i32), i16 0, i16 0}, <{i16, i16, i16, i8*, i8*, i16, i8*, i32, i16, i8*, i32, i16, i16, i8*, i8, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8, i8*, i32, i32*}> <{i16 0, i16 2, i16 5, i8* getelementptr ([17 x i8]* @"str_java_2Flang_2FObject_00", i32 0, i32 0), i8* bitcast (<{i32, <{i8, i8*}>}>* @"[j]red_jit[cattributes]" to i8*), i16 20485, i8* getelementptr ([13 x i8]* @"str_iters_5Fto_5Fjit_00", i32 0, i32 0), i32 ptrtoint (i32* getelementptr ({%Class, {<{<{}>, i32}>, <{<{}>, i32}>}}* null, i32 0, i32 1, i32 0, i32 1) to i32), i16 20485, i8* getelementptr ([6 x i8]* @"str_scale_00", i32 0, i32 0), i32 ptrtoint (i32* getelementptr ({%Class, {<{<{}>, i32}>, <{<{}>, i32}>}}* null, i32 0, i32 1, i32 1, i32 1) to i32), i16 16385, i16 -1, i8* getelementptr ([7 x i8]* @"str__3Cinit_3E_00", i32 0, i32 0), i8 9, i8* bitcast (void (%Env*, %Object*)* @"[J]red_jit.<init>()V" to i8*), i32 28036591, i32* @"[j]red_jit.<init>()V[linetable]", i16 5, i16 -1, i8* getelementptr ([5 x i8]* @"str_main_00", i32 0, i32 0), i8* getelementptr ([23 x i8]* @"str__28_5BLjava_2Flang_2FString_3B_29V_00", i32 0, i32 0), i8* bitcast (void (%Env*, %Object*)* @"[J]red_jit.main([Ljava/lang/String;)V" to i8*), i32 28036591, i32* @"[j]red_jit.main([Ljava/lang/String;)V[linetable]", i16 5, i16 -1, i8* getelementptr ([8 x i8]* @"str_branch1_00", i32 0, i32 0), i8* getelementptr ([5 x i8]* @"str__28I_29I_00", i32 0, i32 0), i8* bitcast (i32 (%Env*, i32)* @"[J]red_jit.branch1(I)I" to i8*), i32 28036591, i32* @"[j]red_jit.branch1(I)I[linetable]", i16 5, i16 -1, i8* getelementptr ([8 x i8]* @"str_branch2_00", i32 0, i32 0), i8* getelementptr ([5 x i8]* @"str__28I_29I_00", i32 0, i32 0), i8* bitcast (i32 (%Env*, i32)* @"[J]red_jit.branch2(I)I" to i8*), i32 28036591, i32* @"[j]red_jit.branch2(I)I[linetable]", i16 16388, i16 -1, i8* getelementptr ([9 x i8]* @"str__3Cclinit_3E_00", i32 0, i32 0), i8 9, i8* bitcast (void (%Env*)* @"[J]red_jit.<clinit>()V" to i8*), i32 28036591, i32* @"[j]red_jit.<clinit>()V[linetable]"}>}

@"[j]red_jit[infostruct]_i8ptr" = private alias i8* bitcast ({{i8*, i32, i8*, void (%Env*)*, i8**, i8*, i8*, i32, i32, i32, i16, i16}, <{i16, i16, i16, i8*, i8*, i16, i8*, i32, i16, i8*, i32, i16, i16, i8*, i8, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8, i8*, i32, i32*}>}* @"[j]red_jit[infostruct]" to i8*)

define private %Object* @"[j]red_jit[ldc]"(%Env* %p0) nounwind alwaysinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = call %Object* @"_bcLdcClass"(%Env* %p0, i8** %t0)
    ret %Object* %t1
}

define external %Object* @"[j]red_jit[ldcext]"(%Env* %p0) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
...
define private %Object* @"[j]red_jit[allocator]"(%Env* %p0) nounwind alwaysinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
...
define external %Object* @"[j]red_jit[allocator][clinit]"(%Env* %p0) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
...
label1:
    %t6 = call %Object* @"[j]red_jit[allocator]"(%Env* %p0)
    ret %Object* %t6
label2:
...
define private i32 @"[j]red_jit.iters_to_jit(I)[get]"(%Env* %p0) nounwind alwaysinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = load i8** %t0
    %t2 = bitcast i8* %t1 to i8*
    %t3 = getelementptr i8* %t2, i32 ptrtoint (i32* getelementptr ({%Class, {<{<{}>, i32}>, <{<{}>, i32}>}}* null, i32 0, i32 1, i32 0, i32 1) to i32)
    %t4 = bitcast i8* %t3 to i32*
    %t5 = load i32* %t4
    ret i32 %t5
}

define private void @"[j]red_jit.iters_to_jit(I)[set]"(%Env* %p0, i32 %p1) nounwind alwaysinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = load i8** %t0
    %t2 = bitcast i8* %t1 to i8*
...
define external i32 @"[j]red_jit.iters_to_jit(I)[get][clinit]"(%Env* %p0) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    %t6 = call i32 @"[j]red_jit.iters_to_jit(I)[get]"(%Env* %p0)
    ret i32 %t6
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define external void @"[j]red_jit.iters_to_jit(I)[set][clinit]"(%Env* %p0, i32 %p1) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    call void @"[j]red_jit.iters_to_jit(I)[set]"(%Env* %p0, i32 %p1)
    ret void
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define private i32 @"[j]red_jit.scale(I)[get]"(%Env* %p0) nounwind alwaysinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = load i8** %t0
    %t2 = bitcast i8* %t1 to i8*
    %t3 = getelementptr i8* %t2, i32 ptrtoint (i32* getelementptr ({%Class, {<{<{}>, i32}>, <{<{}>, i32}>}}* null, i32 0, i32 1, i32 1, i32 1) to i32)
    %t4 = bitcast i8* %t3 to i32*
    %t5 = load i32* %t4
    ret i32 %t5
}

define private void @"[j]red_jit.scale(I)[set]"(%Env* %p0, i32 %p1) nounwind alwaysinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = load i8** %t0
    %t2 = bitcast i8* %t1 to i8*
...
define external i32 @"[j]red_jit.scale(I)[get][clinit]"(%Env* %p0) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    %t6 = call i32 @"[j]red_jit.scale(I)[get]"(%Env* %p0)
    ret i32 %t6
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define external void @"[j]red_jit.scale(I)[set][clinit]"(%Env* %p0, i32 %p1) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    call void @"[j]red_jit.scale(I)[set]"(%Env* %p0, i32 %p1)
    ret void
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define weak void @"[J]red_jit.<init>()V"(%Env* %p0, %Object* %p1) nounwind noinline optsize {
label0:
    %r0 = alloca %Object*
    call void @"checkso"()
    store %Object* %p1, %Object** %r0
    %t0 = load %Object** %r0
    call void @"[j]java.lang.Object.<init>()V[Invokespecial(red_jit,red_jit)]"(%Env* %p0, %Object* %t0)
    ret void
}

define weak void @"[J]red_jit.main([Ljava/lang/String;)V"(%Env* %p0, %Object* %p1) nounwind noinline optsize {
label0:
    %r0 = alloca %Object*
    %z0 = alloca i32
    %i0 = alloca i32
    ...
    br label %label1
label1:
    %t0 = call i32 @"[j]red_jit.iters_to_jit(I)[get]"(%Env* %p0)
    store i32 %t0, i32* %$i1
    %t1 = load i32* %i0
    %t2 = load i32* %$i1
    %t3 = icmp sgt i32 %t1, %t2
    br i1 %t3, label %label3, label %label2
label2:
    %t4 = call %Object* @"[j]java.lang.System.out(Ljava/io/PrintStream;)[GetStatic(red_jit)]"(%Env* %p0)
    store %Object* %t4, %Object** %$r1
    %t5 = call %Object* @"[j]java.lang.StringBuilder[New(red_jit)]"(%Env* %p0)
    store %Object* %t5, %Object** %$r2
    %t6 = load %Object** %$r2
    call void @"[j]java.lang.StringBuilder.<init>()V[Invokespecial(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %t6)
    %t7 = load %Object** %$r2
    %t8 = call %Object* @"[j]str_branch1_3A_00[ldcstring]"(%Env* %p0)
    %t9 = call %Object* @"[j]java.lang.StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;[Invokevirtual(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %t7, %Object* %t8)
    store %Object* %t9, %Object** %$r3
    %t10 = load %Object** %$r3
    %t11 = call i8 @"checknull"(%Env* %p0, %Object* %t10)
    %t12 = load i32* %i0
    %t13 = call %Object* @"[j]java.lang.StringBuilder.append(I)Ljava/lang/StringBuilder;[Invokevirtual(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %t10, i32 %t12)
    store %Object* %t13, %Object** %$r4
    %t14 = load %Object** %$r4
    %t15 = call i8 @"checknull"(%Env* %p0, %Object* %t14)
    %t16 = call %Object* @"[j]java.lang.StringBuilder.toString()Ljava/lang/String;[Invokevirtual(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %t14)
    store %Object* %t16, %Object** %$r5
    %t17 = load %Object** %$r1
    %t18 = call i8 @"checknull"(%Env* %p0, %Object* %t17)
    %t19 = load %Object** %$r5
    call void @"[j]java.io.PrintStream.println(Ljava/lang/String;)V[Invokevirtual(red_jit,java/io/PrintStream)]"(%Env* %p0, %Object* %t17, %Object* %t19)
    %t20 = load i32* %i0
    %t21 = call i32 @"[J]red_jit.branch1(I)I"(%Env* %p0, i32 %t20)
    store i32 %t21, i32* %$i2
    %t23 = load i32* %i0
    %t22 = add i32 %t23, 1
    store i32 %t22, i32* %i0
    br label %label1
label3:
    %t24 = load i32* %z0
    %t25 = icmp eq i32 %t24, 0
    br i1 %t25, label %label5, label %label4
label4:
    %t26 = call i32 @"[J]red_jit.branch1(I)I"(%Env* %p0, i32 42)
    store i32 %t26, i32* %$i3
    br label %label6
label5:
    %t27 = call i32 @"[J]red_jit.branch2(I)I"(%Env* %p0, i32 42)
    store i32 %t27, i32* %$i4
    br label %label6
label6:
    ret void
}

define weak %Object* @"[j]str_branch1_3A_00[ldcstring]"(%Env* %p0) nounwind {
label0:
    %t0 = call %Object* @"_bcLdcString"(%Env* %p0, %Object** @"str_branch1_3A_00_ptr", i8* getelementptr ([9 x i8]* @"str_branch1_3A_00", i32 0, i32 0), i32 8)
    ret %Object* %t0
}

define external void @"[j]red_jit.main([Ljava/lang/String;)V[clinit]"(%Env* %p0, %Object* %p1) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    call void @"[J]red_jit.main([Ljava/lang/String;)V"(%Env* %p0, %Object* %p1)
    ret void
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define weak i32 @"[J]red_jit.branch1(I)I"(%Env* %p0, i32 %p1) nounwind noinline optsize {
label0:
    %i0 = alloca i32
    %i1 = alloca i32
    %$i2 = alloca i32
    ...
    br label %label1
label1:
    %t0 = call i32 @"[j]red_jit.scale(I)[get]"(%Env* %p0)
    store i32 %t0, i32* %$i2
    %t1 = load i32* %i1
    %t2 = load i32* %$i2
    %t3 = icmp sgt i32 %t1, %t2
...
define external i32 @"[j]red_jit.branch1(I)I[clinit]"(%Env* %p0, i32 %p1) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    %t6 = call i32 @"[J]red_jit.branch1(I)I"(%Env* %p0, i32 %p1)
    ret i32 %t6
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define weak i32 @"[J]red_jit.branch2(I)I"(%Env* %p0, i32 %p1) nounwind noinline optsize {
label0:
    %i0 = alloca i32
    %i1 = alloca i32
    %$i2 = alloca i32
...
define external i32 @"[j]red_jit.branch2(I)I[clinit]"(%Env* %p0, i32 %p1) nounwind noinline optsize {
label0:
    %t0 = call i8** @"[j]red_jit[info]"()
    %t1 = bitcast i8** %t0 to {i8*, i32}*
    %t2 = getelementptr {i8*, i32}* %t1, i32 0, i32 1
    ...
    br i1 %t5, label %label1, label %label2
label1:
    %t6 = call i32 @"[J]red_jit.branch2(I)I"(%Env* %p0, i32 %p1)
    ret i32 %t6
label2:
    call void @"_bcInitializeClass"(%Env* %p0, i8** %t0)
    br label %label1
...
define weak void @"[J]red_jit.<clinit>()V"(%Env* %p0) nounwind noinline optsize {
label0:
    call void @"[j]red_jit.iters_to_jit(I)[set]"(%Env* %p0, i32 50)
    call void @"[j]red_jit.scale(I)[set]"(%Env* %p0, i32 10000)
    ret void
}

define private %Object* @"[j]java.lang.StringBuilder[New(red_jit)]"(%Env* %p0) nounwind alwaysinline optsize {
label0:
    %t0 = call %Object* @"[j]java.lang.StringBuilder[allocator][clinit]"(%Env* %p0)
    ret %Object* %t0
}

define private %Object* @"[j]java.lang.System.out(Ljava/io/PrintStream;)[GetStatic(red_jit)]"(%Env* %p0) nounwind alwaysinline optsize {
label0:
    %t0 = call %Object* @"[j]java.lang.System.out(Ljava/io/PrintStream;)[get][clinit]"(%Env* %p0)
    ret %Object* %t0
}

define private i32 @"[j]red_jit.branch1(I)I[Invokestatic(red_jit)]"(%Env* %p0, i32 %p1) nounwind alwaysinline optsize {
label0:
    %t0 = call i32 @"[j]red_jit.branch1(I)I[clinit]"(%Env* %p0, i32 %p1)
    ret i32 %t0
}

define private %Object* @"[j]java.lang.StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;[Invokevirtual(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %p1, %Object* %p2) nounwind alwaysinline optsize {
label0:
    %t0 = call %Object* @"[J]java.lang.StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;"(%Env* %p0, %Object* %p1, %Object* %p2)
    ret %Object* %t0
}

define private %Object* @"[j]java.lang.StringBuilder.append(I)Ljava/lang/StringBuilder;[Invokevirtual(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %p1, i32 %p2) nounwind alwaysinline optsize {
label0:
    %t0 = call %Object* @"[J]java.lang.StringBuilder.append(I)Ljava/lang/StringBuilder;"(%Env* %p0, %Object* %p1, i32 %p2)
    ret %Object* %t0
}

define private %Object* @"[j]java.lang.StringBuilder.toString()Ljava/lang/String;[Invokevirtual(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %p1) nounwind alwaysinline optsize {
label0:
    %t0 = call %Object* @"[J]java.lang.StringBuilder.toString()Ljava/lang/String;"(%Env* %p0, %Object* %p1)
    ret %Object* %t0
}

define private void @"[j]java.lang.Object.<init>()V[Invokespecial(red_jit,red_jit)]"(%Env* %p0, %Object* %p1) nounwind alwaysinline optsize {
label0:
    call void @"[J]java.lang.Object.<init>()V"(%Env* %p0, %Object* %p1)
    ret void
}

define private i32 @"[j]red_jit.branch2(I)I[Invokestatic(red_jit)]"(%Env* %p0, i32 %p1) nounwind alwaysinline optsize {
label0:
    %t0 = call i32 @"[j]red_jit.branch2(I)I[clinit]"(%Env* %p0, i32 %p1)
    ret i32 %t0
}

define private void @"[j]java.lang.StringBuilder.<init>()V[Invokespecial(red_jit,java/lang/StringBuilder)]"(%Env* %p0, %Object* %p1) nounwind alwaysinline optsize {
label0:
    call void @"[J]java.lang.StringBuilder.<init>()V"(%Env* %p0, %Object* %p1)
    ret void
}

define private void @"[j]java.io.PrintStream.println(Ljava/lang/String;)V[Invokevirtual(red_jit,java/io/PrintStream)]"(%Env* %p0, %Object* %p1, %Object* %p2) nounwind alwaysinline optsize {
label0:
    call void @"[j]java.io.PrintStream.println(Ljava/lang/String;)V[lookup]"(%Env* %p0, %Object* %p1, %Object* %p2)
    ret void
}

define external i8** @"[j]red_jit[info]"() nounwind alwaysinline optsize {
label0:
    ret i8** bitcast ({{i8*, i32, i8*, void (%Env*)*, i8**, i8*, i8*, i32, i32, i32, i16, i16}, <{i16, i16, i16, i8*, i8*, i16, i8*, i32, i16, i8*, i32, i16, i16, i8*, i8, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8*, i8*, i32, i32*, i16, i16, i8*, i8, i8*, i32, i32*}>}* @"[j]red_jit[infostruct]" to i8**)
}
